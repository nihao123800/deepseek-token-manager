...
- Username：设置一个用户名（建议用英文，比如 `ai-token-service`）
- 完成人机验证
...
- 填写项目信息：
  ...
  - Project name：填写 `ai-token-service`
...
2. 填写仓库信息：
   - Repository name：`ai-token-service`
   - Description：`AI Token Customer Management System`
   - 选择 **Public**
...
6. 等待1-2分钟，页面会显示你的网站地址，类似：
   ```
   https://你的用户名.github.io/ai-token-service/
   ```
...
- GitHub Pages会自动重新部署
- 等待1-2分钟
- 访问你的网站：`https://你的用户名.github.io/ai-token-service/`
...
如果你按照以上步骤操作，你的AI Token客户管理系统已经成功部署！
